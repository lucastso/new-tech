...
<section class="h-20 flex sm:flex-col-reverse lg:flex-row justify-between items-center border-b border-gray-100">
    ...
    <div class="flex justify-center items-center gap-12 xs:mr-6 lg:mr-32 font-bold text-black-24" x-data="nav">
        <a href="/">Meus posts</a>
        <a href="/" class="py-2 px-4 border-2 border-black-24 rounded">Novo post +</a>
